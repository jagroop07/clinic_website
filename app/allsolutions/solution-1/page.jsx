...
const page = () => {
 ...
 <Heading heading="	
Provider Enrollment & Credentialing Made Simple

" subheading={"One Registration, Many Networks. Automated Renewal. Consistent Follow-Up. Faster Turnaround. "} link={"/"} linktext={"contact us"} imagelink="https://knackglobal.com/wp-content/uploads/2023/04/Header_Provider-Enrollment-Credentialing-Services-768x531.png"/>    </div>
