    ...
    return !pathname.startsWith('/admin') && <div className="bg-[#004366] sm:px-10 px-2 2xl:px-0 pt-14 pb-7">
        <div className="2xl:container 2xl:mx-auto grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-5">
            <div className="lg:col-span-2">
                ...
                <div className="grid grid-cols-5 gap-4 mt-8 text-white">
                    <div className="sm:w-[50px] sm:h-[50px] w-[40px] h-[40px] flex items-center justify-center border border-white rounded-lg"><FaFacebook className="text-2xl" /></div>
                    <div className="sm:w-[50px] sm:h-[50px] w-[40px] h-[40px] flex items-center justify-center border border-white rounded-lg"><FaInstagram className="text-2xl" /></div>
                    <div className="sm:w-[50px] sm:h-[50px] w-[40px] h-[40px] flex items-center justify-center border border-white rounded-lg"><FaWhatsapp className="text-2xl" /></div>
                    <div className="sm:w-[50px] sm:h-[50px] w-[40px] h-[40px] flex items-center justify-center border border-white rounded-lg"><FaTelegram className="text-2xl" /></div>
                    <div className="sm:w-[50px] sm:h-[50px] w-[40px] h-[40px] flex items-center justify-center border border-white rounded-lg"><BsTwitterX className="text-2xl" /></div>
                </div>
            </div>
            <div>
        ...
        <div className="2xl:container 2xl:mx-auto relative mt-12 bg-red-100">
            ...
            <div className="absolute bg-[#004366] text-center sm:top-[-10px] top-[-40px] left-[50%] translate-x-[-50%] lg:w-[45%] md:w-[80%] sm:w-[90%] w-[100%]">
                <p className="text-gray-400 text-sm lg:text-base">© 2024 | All Rights Reserved | Powered by Global Tech Solutions</p>
            </div>
        </div>
    </div>
}