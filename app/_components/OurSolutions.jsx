    ...
    <>
      <div className='p-4 mt-20'> <h1 className='text-5xl font-bold text-center text-blue-900'>After Service</h1>
        ...
        <div className='solutions'>
          ...
          {solutions?.map((e, i) => <div key={i} className={`md:flex justify-center my-5 ${i % 2 == 0 ? "flex-row-reverse" : ""} gap-5 align-middle`}>
            <div className='flex justify-center align-center'>
              <div className='h-[400px] w-[400px] overflow-hidden relative'>
                <Image
                  className='mt-7 object-cover'
                  layout="fill"
                  priority
                  alt='...'
                  src={e.solution_first?.solution_image} />
              </div>
            </div>
