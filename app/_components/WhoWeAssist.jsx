        ...
        <>
            <div className="md:flex py-16 bg-blue-100 md:px-6 px-2">
                <div className="md:max-w-[50%] md:mt-0 mt-10 sm:px-8">
                    ...
                    <Link href={"/contact"} className="bg-blue-900 mt-6 py-2 px-6 w-[180px] flex rounded-xl text-white">Learn More <span className="ms-2 mt-1"><FaArrowCircleRight /></span></Link>
                </div>
